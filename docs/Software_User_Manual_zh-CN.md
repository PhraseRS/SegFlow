...
如需快速熟悉数据集加载和后续操作，可下载 [SegFlow 示例数据集（百度网盘）](https://pan.baidu.com/s/19oimOyu0l7Ouc2WHPwEaFQ)，提取码为 `wpur`。下载并解压后，选择解压得到的数据集根目录即可。该数据集可用于验证数据集导入、样本浏览、数据分析以及模型训练与评估流程。
