...
from PySide6.QtWidgets import (
    QWidget, QVBoxLayout, QCheckBox, QFrame, QLabel, QPlainTextEdit,
...
class AdvancedConfigWidget(QWidget):
    ...
    def _setup_ui(self):
        ...
        self.check_expert_mode = QCheckBox("🛠️ 开启高级专家配置 (Enable Expert Settings)")
        self.check_expert_mode.setStyleSheet("font-weight: bold; color: #424242;")
        self.check_expert_mode.setToolTip("开启后可调整 MMSegmentation 的底层或较不常用的超参数")
        header_layout.addWidget(self.check_expert_mode)
        ...
        main_layout.addWidget(self.container_advanced)
        
        # 初始状态：折叠
        self.container_advanced.setVisible(False)
        self.check_expert_mode.toggled.connect(self._on_expert_mode_toggled)
