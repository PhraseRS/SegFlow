...
- [ ] **任务 1.1: 列表与画廊的双向选择同步 (Two-Way Selection Sync)**
...
- [ ] **任务 1.2: 完善“画廊 -> 详情”的穿梭交互 (Macro to Micro Transition)**
...
- [ ] **任务 1.3: 顶部工具栏状态管理 (Toolbar State Awareness)**
...
- [ ] **任务 1.4: 缩略图缓存固化 (Thumbnail Cache Persistence - 性能兜底)**
